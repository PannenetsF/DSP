...
单位冲激响应如\figref{l2p5}， 频率响应如\figref{l2p6} ，阶数为 37。
...
经过查询相关资料，对于标准频带\footnote{低通、带通、高通和带阻四类滤波器}的 FIR 设计，基于 \lstinline{fir1} 是最经典的方法，可以实现加窗的线性相位 FIR 数字滤波器。参考 \figref{l2p6} 满足条件。
